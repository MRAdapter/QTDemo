...
# Generated by qmake (2.01a) (Qt 4.8.5) on: ?? ?? 19 00:44:40 2016
# Project:  QTDemo.pro
# Template: app
# Command: c:\Qt\4.8.5\bin\qmake.exe -spec c:\Qt\4.8.5\mkspecs\win32-g++ CONFIG+=declarative_debug -o Makefile QTDemo.pro
#############################################################################
...
Makefile: QTDemo.pro  c:/Qt/4.8.5/mkspecs/win32-g++/qmake.conf c:/Qt/4.8.5/mkspecs/features/device_config.prf \
		...
		c:/Qt/4.8.5/mkspecs/features/declarative_debug.prf \
	...
	$(QMAKE) -spec c:\Qt\4.8.5\mkspecs\win32-g++ CONFIG+=declarative_debug -o Makefile QTDemo.pro
